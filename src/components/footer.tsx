...
export function Footer() {
    return (
        ...
        <div className="container flex flex-col items-center justify-between gap-4 px-4 py-8 md:flex-row md:px-6">
          ...
          <p className="text-center text-sm text-primary-foreground/80">&copy; 2025 IonaBros Impianti srls SS 148 pontina km.105.500 04019 Terracina Lt P.IVA 03291610594</p>
